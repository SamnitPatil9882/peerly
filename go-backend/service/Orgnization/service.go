...
import (
	...
	email "joshsoftware/peerly/service/Email"
	"joshsoftware/peerly/util"
	"time"
...
type service struct {
	OranizationRepo     db.OrganizationStorer
	OTPVerificationRepo db.OTPVerificationStorer
}
...
func NewService(oranizationRepo db.OrganizationStorer, otpRepo db.OTPVerificationStorer) Service {
	return &service{
